    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{__('siteTrans.partners')}}</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('siteTrans.partners')}}</a>
                        </li>
                        ...
                        @foreach($rows as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.partners.show', $row->id) }}"
                                    ...
                                    <span class="delete-row text-danger"
                                          data-url="{{url('admin/partners/'.$row->id)}}"><i
