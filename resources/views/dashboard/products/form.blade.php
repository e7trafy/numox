...
<div class="col-md-6">
    <div class="mb-1">
        ...
        <textarea class="form-control ckeditor" name="content[ar]" id="content-ar"
            {{ Route::is('*.create') ? 'required' : '' }}>{{ $row->getTranslation('content', 'ar') ?? old('content.ar') }}</textarea>
        @include('dashboard.layouts.shared.validationStatus')
    </div>
</div>
<div class="col-md-6">
    <div class="mb-1">
        ...
        <textarea class="form-control ckeditor" name="content[en]" id="content-en"
            {{ Route::is('*.create') ? 'required' : '' }}>{{ $row->getTranslation('content', 'en') ?? old('content.en') }}</textarea>
        @include('dashboard.layouts.shared.validationStatus')
    </div>
</div>
