    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{__('siteTrans.pricing')}}</h4>
                    ...
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        ...
                        @foreach($rows as $row)
                            <tr>
                                ...
                                <td>{{$row->title}}</td>
                                <td>
                                    <a href="{{ route('admin.pricing.edit', $row->id) }}"
                                    ...
                                    <a href="{{ route('admin.pricing.show', $row->id) }}"
                                    ...
                                    <span class="delete-row text-danger"
                                          data-url="{{url('admin/pricing/'.$row->id)}}"><i
