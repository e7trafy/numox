    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{__('siteTrans.sources')}}</h4>
                    ...
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        ...
                        @foreach($rows as $row)
                            <tr>
                                ...
                                <td>{{$row->title}}</td>
                                <td>
                                    <a href="{{ route('admin.sources.edit', $row->id) }}"
                                    ...
                                    <a href="{{ route('admin.sources.show', $row->id) }}"
                                    ...
                                    <span class="delete-row text-danger"
                                          data-url="{{url('admin/sources/'.$row->id)}}"><i
